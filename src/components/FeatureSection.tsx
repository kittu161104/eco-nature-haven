...
const FeatureSection = () => {
  return (
    <section className="py-16 bg-eco-50 dark:bg-gray-900 dark:bg-opacity-60">
      <div className="eco-container">
        <div className="text-center mb-12">
          <h2 className="section-title dark:text-eco-300">Why Choose Natural Green</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm text-center hover:shadow-md transition-shadow duration-300">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-eco-100 dark:bg-eco-900 text-eco-600 dark:text-eco-400 rounded-full mb-4">
                <feature.icon className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-serif font-bold text-gray-900 dark:text-white mb-2">{feature.title}</h3>
